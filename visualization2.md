...
I initially chose this visualization because the original was so poorly designed. The title, labels, color choices, and format were unclear and didn't make it easy to even determine what the point of the visual was. In creating my redesigned visualization, I tried to, first and foremost, fix the lack of clarity so that it can be read easily by my audiences. By creating the above heat map, I believe I have solved those issues. 

First, the title is much clearer and speaks to the multiple variables that the chart shows as having a correlation with unemployment rates. Second, I made the labels clearer by renaming "Experienced Graduate" to "Graduates with Work Experience" and "Graduate Degree" to "Graduate Level Degree Holder." I also made sure that the college major labels were listed horizontally, rather than vertically as seen in the original vizualization, making it much easier to read. Third, and most importantly, I changed the format of the graphic to a heat map. Based on user feedback and my own brainstorming, I believe this organization of data makes it easy to quickly see trends in the data regarding high versus low unemployment levels and where those fall regarding college major and educational level. It's easy to look at the coloration on this map as see that the top left corner, Archictect majors right out of college have the highest unemployment rates while Education majors with a graduate level degree have the lowest rate of unemployment. This is also reated to my choice of color, as orange, a warm color, indicates a worse unemploymnet rate than blue, a cool color. Based on natural associations with color, this adds another layer of clarity as viewers will likely view the organge as negative without much thought and will view the cool as a more calm, "good" color. In addition, the rows and columns are close enough together that you can compare Architecture and Education as easily as you can Architecture and Arts. That is one of the greatest strengths of this visualization that I wasn't able to replicate with a different type of chart, such as a grouped bar chart, as it spread the infomration out too much to make comparions.

Overall, I feel that this visualization is much stronger in terms of clarity, and is also much more pleasing aesthetically.
